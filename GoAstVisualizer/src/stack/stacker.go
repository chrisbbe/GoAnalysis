//Package stack provides an implementation of the
//Stack abstract-datastructure, basically providing
//the standard stack operating primitives.
//
...
//Stack is an array datastructure with the
// properties of a LIFO queue.
type Stack []interface{}

//Len returns the size(length) of the stack.
...
//stack, or returns an error message if the stack is empty.
...
//stack, or error message if the stack is empty.
